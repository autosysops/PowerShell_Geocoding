...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\Geocoding\functions", "$global:testroot\..\Geocoding\internal\functions"),

	[string]
	$ModuleName = "Geocoding",
...
$CommandPath = @(
    "$global:testroot\..\Geocoding\functions"
    "$global:testroot\..\Geocoding\internal\functions"
)
